...
import { SexConstants, SexList } from "../../shared/constants";
...
const EditProfile = () => {
    ...
    ["isGroupExhibition"].forEach(
        (key) => (profileData[key] = profileData[key] || false)
    );
    ...
    const fetchDetails = async () => {
        try {
            ...
            if (response.success && response.data) {
                setProfileData({
                    ...response.data, profilePic: response.data.profilePic ? [{
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                            <UploadHandler
                                profileView={true}
                                accept="image/*"
                                defaultValue={profileData.profilePic || [{
                                    url: `/images/default_profile_${profileData.sex === SexConstants.FEMALE ? SexConstants.FEMALE : SexConstants.MALE}.png`,
                                    active: true,
                                    id: "profile_image"
                                }]}
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField
                                ...
                                onChange={(event) =>
                                    updateFields({ sex: event.target.value })
                                }
                            >
